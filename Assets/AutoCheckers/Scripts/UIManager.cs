...
public class UIManager : MonoBehaviour
{
    ...
    public void UpdateHumanUI()
    {
        ...
        GameManager.instance.Human.ClassHeroes = GameManager.instance.Human.ClassHeroes.OrderByDescending(pair => pair.Value)
            .ToDictionary(pair => pair.Key, pair => pair.Value);
        GameManager.instance.Human.RaceHeroes = GameManager.instance.Human.RaceHeroes.OrderByDescending(pair => pair.Value)
            .ToDictionary(pair => pair.Key, pair => pair.Value);
